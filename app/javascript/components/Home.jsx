      ...
      <main>
        <div className="relative isolate">
          ...
          <div className="overflow-hidden">
            <div className="mx-auto max-w-7xl px-6 pb-2 pt-16 sm:pt-24 lg:px-8 lg:pt-24">
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                  <h1 className=" font-bold tracking-tight text-gray-900 text-5xl md:text-6xl">
                    We’re changing the way people join to events.
                  </h1>
                  <p className="mt-6 text-lg md:text-xl leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
