...
function Event({ eventData, actionFunction, actionName }) {
  ...
  return (
    <article
      key={id}
      className="flex max-w-xl flex-col items-start  border border-gray-100 shadow-lg rounded-2xl rounded-b-none"
    >
      ...
      <div className="px-5 w-full h-full">
        ...
        <div className="cursor-default">
          <h3 className="mt-4 capitalize text-2xl font-semibold leading-6 text-gray-900 ">
